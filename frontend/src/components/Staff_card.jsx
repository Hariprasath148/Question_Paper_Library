...
export const Staff_card = ({ Staff }) => {
  ...
  return (
    <>
      <div className="container-xxl rounded-4 overflow-hidden p-3" id="staff-card">
        <div className="card m-0 rounded-0 border-0">
          <div className="card-header row m-0 p-0 justify-content-between bg-transparent border-0">
            <div className="col-md-4 col-6 d-flex p-0 ps-2 align-items-center">
              ...
              <div id="staff-label" className="card-header bg-transparent h5 border-0 fw-normal text-wrap ps-2 p-0">Staff Info</div>
            </div>
        ...
        <div className="card-body p-3">
          <div className="card-title h3 mt-3 ms-3">{Staff.staffname}</div>
          <div className="row justify-content-around mt-4 gap-2">
            ...
            <div className="row collapse justify-content-around mt-3 gap-2 p-0" id="Collapse-staff-Info">
              ...
              <div className="col-12 col-sm-3 info-box py-2 pxl-3 rounded-2">
                <div className="info-title fw-light mb-1">Email :</div>
                <div className="info-data fs-6 overflow-auto">{Staff.staffname}</div>
              </div>
            </div>
            <div className="row">
              <button type="button" className="btn btn-link" id="collapse-btn" data-bs-toggle="collapse" href="#Collapse-staff-Info" role="button" aria-expanded="false" aria-controls="Collapse-staff-Info">More</button>
            </div>
          </div>
        </div>
      </div>
